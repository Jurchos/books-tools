...
* fliscaner: скачиваем архивы с книгами и дампами с Флибусты/Либрусека
* flidumper: по дампам генерим базы данных, дополнительную инфу (авторы)
* fb2cut: перепаковываем архивы
* flihasher: по перепакованным архивам генерим хэши
* flimerger: добавляем новые перепакованные архивы к существующим
* fliparser: генерируем inpx, reviews, compilations, contents, etc
